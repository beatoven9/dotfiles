...
function makeLinks() {
    ...
    if [ "$this_user" = "Reeds-MBP.lan" ][ "$this_user" = "laon-macbook"  ] || [ "$this_user" = "laon-surface"  ] || [ "$this_user" = "laon-pc" ] || [ "$this_user" = "laonpbp" ] || [ "$this_user" = "laon-laptop" ]; then
...
if [[ $REPLY =~ ^[Yy]$ ]]; then
    ...
    if [ "$this_user" = "laon-surface"  ] || [ "$this_user" = "laon-pc" ] || [ "$this_user" = "laonpbp" ] || [ "$this_user" = "laon-laptop" ]; then
	    xmodmap ~/.Xmodmap;
    fi
fi;
